...
<section class="audience-section" id="small">
  ...
  <div class="model-table-wrap">
    <table class="model-table">
      <thead><tr><th>Model</th><th>Sizes</th><th>Score</th><th>Best for</th><th>RAM (Q4)</th><th>Cost vs cloud</th><th>Get it</th></tr></thead>
      <tbody>
        <tr class="model-top-pick"><td><strong>Qwen 2.5</strong> (tiny)</td><td>0.5B · 1.5B<br><span class="model-ctx">128k ctx · Sep 2024</span></td><td class="model-score"><span class="model-score-val">83.3</span><span class="model-score-bench">MMLU · 32B</span></td><td>Runs on a Raspberry Pi 5 or a 2015 laptop. <span class="model-license-note">Apache 2.0</span></td><td>1.5B → 2 GB</td><td>$0 <span class="model-cost-vs">vs ~$0.005 / prompt (Haiku)</span></td><td><code>ollama pull qwen2.5:1.5b</code></td></tr>
        <tr><td><strong>Phi 3.5 mini</strong></td><td>3.8B<br><span class="model-ctx">128k ctx · Aug 2024</span></td><td class="model-score"><span class="model-score-val">69.0</span><span class="model-score-bench">MMLU</span></td><td>Quality-per-parameter leader. Solid at code + reasoning. <span class="model-license-note">MIT</span></td><td>3.8B → 3 GB</td><td>$0 <span class="model-cost-vs">vs ~$0.005 / prompt (Haiku)</span></td><td><code>ollama pull phi3.5</code></td></tr>
        <tr><td><strong>Llama 3.2</strong> (small)</td><td>1B · 3B<br><span class="model-ctx">128k ctx · Sep 2024</span></td><td class="model-score"><span class="model-score-val">66.7</span><span class="model-score-bench">MMLU · 8B</span></td><td>Instant streaming for autocomplete, short-form chat. <span class="model-license-note">Llama 3.2</span></td><td>3B → 3 GB</td><td>$0 <span class="model-cost-vs">vs ~$0.005 / prompt (Haiku)</span></td><td><code>ollama pull llama3.2:3b</code></td></tr>
        ...
        <tr><td><strong>Falcon 3</strong> (small)</td><td>1B · 3B<br><span class="model-ctx">32k ctx · Dec 2024</span></td><td class="model-score"><span class="model-score-val">57.8</span><span class="model-score-bench">MMLU · 7B</span></td><td>TII's small Falcons. Sovereign-friendly. <span class="model-license-note">TII Falcon 2.0</span></td><td>3B → 3 GB</td><td>$0 <span class="model-cost-vs">vs cloud</span></td><td><code>ollama pull falcon3:3b</code></td></tr>
...
<section class="audience-section" id="moe">
  ...
  <div class="model-table-wrap">
    <table class="model-table">
      ...
      <tbody>
        <tr class="model-top-pick"><td><strong>DeepSeek V3</strong> (again)</td><td>685B params · ~37B active<br><span class="model-ctx">128k ctx · Dec 2024</span></td><td class="model-score"><span class="model-score-val">95.4</span><span class="model-score-bench">GSM8K</span></td><td>The current OSS MoE flagship. Only for fat servers. <span class="model-license-note">DeepSeek license</span></td><td>~400 GB</td><td>$0 <span class="model-cost-vs">vs GPT-4-class rates</span></td><td><code>ollama pull deepseek-v3</code></td></tr>
        <tr><td><strong>DeepSeek Coder V2</strong> (MoE) (again)</td><td>16B params · ~2.4B active<br><span class="model-ctx">128k ctx · Jun 2024</span></td><td class="model-score"><span class="model-score-val">90.2</span><span class="model-score-bench">HumanEval</span></td><td>MoE coding model. Very fast for its capability. See Coding table. <span class="model-license-note">DeepSeek license</span></td><td>16B → 10 GB</td><td>$0 <span class="model-cost-vs">vs ~$1 / complex refactor</span></td><td><code>ollama pull deepseek-coder-v2</code></td></tr>
