...
<div class="theme-gallery" role="list">
  <figure class="theme-tile" role="listitem" data-mode="dark"><img class="theme-tile-img" src="/img/themes/cosmos.png" alt="cosmos — Milky Way over an alpine lake" width="600" height="338" loading="lazy"><figcaption class="theme-tile-cap"><span class="theme-tile-name">cosmos</span><span class="theme-tile-mode">dark · default</span><span class="theme-tile-hue">milky way + alpine lake</span><span class="theme-tile-credit">Pascal Debrunner · Unsplash</span></figcaption></figure>
  <figure class="theme-tile" role="listitem" data-mode="dark"><img class="theme-tile-img" src="/img/themes/circuit.png" alt="circuit — dark techy blocks" width="600" height="338" loading="lazy"><figcaption class="theme-tile-cap"><span class="theme-tile-name">circuit</span><span class="theme-tile-mode">dark</span><span class="theme-tile-hue">techy cyan-on-black</span><span class="theme-tile-credit">A Chosen Soul · Unsplash</span></figcaption></figure>
  <figure class="theme-tile" role="listitem" data-mode="dark"><img class="theme-tile-img" src="/img/themes/egret.png" alt="egret — cattle egret portrait" width="600" height="338" loading="lazy"><figcaption class="theme-tile-cap"><span class="theme-tile-name">egret</span><span class="theme-tile-mode">dark</span><span class="theme-tile-hue">cattle egret on black</span><span class="theme-tile-credit">David Clode · Unsplash</span></figcaption></figure>
  <figure class="theme-tile" role="listitem" data-mode="dark"><img class="theme-tile-img" src="/img/themes/reef.png" alt="reef — green brain coral" width="600" height="338" loading="lazy"><figcaption class="theme-tile-cap"><span class="theme-tile-name">reef</span><span class="theme-tile-mode">dark</span><span class="theme-tile-hue">green brain coral</span><span class="theme-tile-credit">David Clode · Unsplash</span></figcaption></figure>
  <figure class="theme-tile" role="listitem" data-mode="dark"><img class="theme-tile-img" src="/img/themes/crater.png" alt="crater — fresh Mars impact" width="600" height="338" loading="lazy"><figcaption class="theme-tile-cap"><span class="theme-tile-name">crater</span><span class="theme-tile-mode">dark</span><span class="theme-tile-hue">fresh mars impact</span><span class="theme-tile-credit">NASA · Unsplash</span></figcaption></figure>
  <figure class="theme-tile" role="listitem" data-mode="dark"><img class="theme-tile-img" src="/img/themes/dusk.png" alt="dusk — alpenglow at sunset" width="600" height="338" loading="lazy"><figcaption class="theme-tile-cap"><span class="theme-tile-name">dusk</span><span class="theme-tile-mode">dark</span><span class="theme-tile-hue">alpenglow at sunset</span><span class="theme-tile-credit">Pascal Debrunner · Unsplash</span></figcaption></figure>
  <figure class="theme-tile" role="listitem" data-mode="light"><img class="theme-tile-img" src="/img/themes/prism.png" alt="prism — pastel isometric blocks" width="600" height="338" loading="lazy"><figcaption class="theme-tile-cap"><span class="theme-tile-name">prism</span><span class="theme-tile-mode">light</span><span class="theme-tile-hue">pastel isometric blocks</span><span class="theme-tile-credit">A Chosen Soul · Unsplash</span></figcaption></figure>
  <figure class="theme-tile" role="listitem" data-mode="light"><img class="theme-tile-img" src="/img/themes/bloom.png" alt="bloom — orange lilies on lime" width="600" height="338" loading="lazy"><figcaption class="theme-tile-cap"><span class="theme-tile-name">bloom</span><span class="theme-tile-mode">light</span><span class="theme-tile-hue">orange lilies · lime</span><span class="theme-tile-credit">Natalie Kinnear · Unsplash</span></figcaption></figure>
  <figure class="theme-tile" role="listitem" data-mode="light"><img class="theme-tile-img" src="/img/themes/summit.png" alt="summit — Ama Dablam at dawn" width="600" height="338" loading="lazy"><figcaption class="theme-tile-cap"><span class="theme-tile-name">summit</span><span class="theme-tile-mode">light</span><span class="theme-tile-hue">ama dablam at dawn</span><span class="theme-tile-credit">Eugene Ga · Unsplash</span></figcaption></figure>
  <figure class="theme-tile" role="listitem" data-mode="light"><img class="theme-tile-img" src="/img/themes/ridge.png" alt="ridge — pastel-pink range" width="600" height="338" loading="lazy"><figcaption class="theme-tile-cap"><span class="theme-tile-name">ridge</span><span class="theme-tile-mode">light</span><span class="theme-tile-hue">pastel-pink range</span><span class="theme-tile-credit">Marek Piwnicki · Unsplash</span></figcaption></figure>
</div>
