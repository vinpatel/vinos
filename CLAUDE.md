...
- [x] I11 THE PIVOT — lean base + 8 opt-in bundles (ai/dev/media/office/gaming/productivity/comms/browser). vinos-menu (Super+Ctrl+O), vinos-install-once first-boot notifier, gum-based confirm UX. Base packages 196 → 190. docs/BUNDLES.md. **ISO shrank from 2.9 GB → 2.2 GB, well under the 3 GB budget.** Matrix pass: 5.1+5.2+5.4+5.5+offline all green.
